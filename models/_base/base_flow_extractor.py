    ...
    def __init__(self,
        ...
        if self.side_size is not None:
            self.transforms = torchvision.transforms.Compose([
                ...
                torchvision.transforms.Resize((self.side_size, self.side_size)),
    ...
    def maybe_show_pred(self, batch_feats: torch.Tensor, batch: torch.Tensor):
        ...
        if self.show_pred:
            for idx, flow in enumerate(batch_feats):
                ...
                img_flow = flow
                # cv2.imwrite(f'/home/wangyuxuan1/codes/video_features/cases/{idx}.png', img_flow[:, :, [2, 1, 0]] / 255.0)
                cv2.imwrite(f'/home/wangyuxuan1/codes/video_features/cases/flow_{idx}.png', img_flow[:, :, [2, 1, 0]])
                cv2.imwrite(f'/home/wangyuxuan1/codes/video_features/cases/img_{idx}.png', img[:, :, [2, 1, 0]])
